...
fetch("/api/produttori?order=desc")
                ...
                <div class="col-lg-3 my-2">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p>Q.tà TOT: <b>${prod.nome_produttore} ${prod.nome_produttore}</b></p>
                            <p>Q.tà Disp: <b>${prod.nome_produttore} ${prod.nome_produttore}</b></p>
                            <p>Prezzo: <b>${prod.nome_produttore}</b></p>
