...
def get_dati_prenotazioni():
    ...
    for prenot in prenotazioni:
        ...
        dict_prenot = prenot[0].to_dict()
        dict_prenot['lotto'] = prenot[1].to_dict()
        dict_prenot['lotto']['prodotto'] = prenot[2].to_dict()
        dict_prenot['lotto']['prodotto']['produttore'] = prenot[3].to_dict()
