...
def init_db():
    ...
    if not User.query.first():
        ...
        prodotti = [
            Prodotto(produttore_id=1, nome='Olio extravergine di oliva Bio', immagine='/static/imgs/prodotti/olio.jpg'),
            Prodotto(produttore_id=1, nome='Mele Golden', immagine='/static/imgs/prodotti/mele.jpg'),
            Prodotto(produttore_id=2, nome='Farina di grano tenero', immagine='/static/imgs/prodotti/farina.jpg'),
            Prodotto(produttore_id=2, nome='Miele di acacia Bio', immagine='/static/imgs/prodotti/miele.jpg'),
            Prodotto(produttore_id=3, nome='Riso Originario integrale', immagine='/static/imgs/prodotti/riso.jpg'),
            Prodotto(produttore_id=3, nome='Formaggio Toma', immagine='/static/imgs/prodotti/formaggio.jpg'),
            Prodotto(produttore_id=4, nome='Zucchine novelle', immagine='/static/imgs/prodotti/zucchine.jpg'),
        ]
