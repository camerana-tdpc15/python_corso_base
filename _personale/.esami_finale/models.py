...
# RELATIONSHIPS
   # prenotazioni = db.relationship('Prenotazione', back_populates='utenti', lazy='dynamic')'-prenotazioni.utenti'
...
# RELATIONSHIPS
    ...
    #locali =db.relationship('Locale', back_populates ='evento')

   # serialize_rules = ('-repliche.evento','-locali.evento')
