...
def esercizio_stringhe():
    ...
    str1 = request.args.get('stringa1', default='Rossi')
    str2 = request.args.get('stringa2', default='Antonio')
    ...
    return render_template('esercizio4.html', dizionario=dizionario)
