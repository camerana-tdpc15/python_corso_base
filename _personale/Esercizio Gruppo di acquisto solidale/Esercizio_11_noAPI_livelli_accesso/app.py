...
def home():
    ...
    return render_template('home.html', prodotti_disponibili=prodotti_disponibili, user=g.user)
...
def carrello():
    if 'logged_in' in session:
        ...
        return render_template('carrello.html', prenotazioni=prenotazioni, totale=totale, user=g.user)
    return redirect(url_for('login'))
