...
def init_db():
    ...
    if not User.query.first():
        ...
        prodotti = [
            Prodotto(produttore_id=1, nome='Olio extravergine di oliva Bio', immagine='/static/imgs/prodotti/olio_oliva_bio.jpg'),
            Prodotto(produttore_id=1, nome='Mele Golden', immagine='/static/imgs/prodotti/mele_golden.jpg'),
            Prodotto(produttore_id=2, nome='Farina di grano tenero', immagine='/static/imgs/prodotti/farina_di_grano_tenero.jpg'),
            Prodotto(produttore_id=2, nome='Miele di acacia Bio', immagine='/static/imgs/prodotti/miele_di_acacia_bio.jpg'),
            Prodotto(produttore_id=3, nome='Riso Originario integrale', immagine='/static/imgs/prodotti/riso_originario_integrale.jpg'),
            Prodotto(produttore_id=3, nome='Formaggio Toma', immagine='/static/imgs/prodotti/formaggio_toma.jpg'),
            Prodotto(produttore_id=4, nome='Zucchine novelle', immagine='/static/imgs/prodotti/zucchine_novelle.jpg'),
        ]
