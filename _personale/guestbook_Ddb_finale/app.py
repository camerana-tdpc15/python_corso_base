import os
from flask import Flask, render_template,request,session,redirect,flash,url_for,jsonify # utiliziamo il modulo "flash" per mostrare i messaggi di esito oppure errore
from flask_sqlalchemy import SQLAlchemy
#utiliziamo il modulo escape dal pacco markupsafe per prevenire attacchi di injection, garantendo che il contenuto della nostra pagina e sicuro
