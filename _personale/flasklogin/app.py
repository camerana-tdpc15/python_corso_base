...
app = Flask(__name__)
# Impostimo una chiave segreta (che vediamo solo noi sviluppatori)
#La chiave servra per crittografare e firmare i coockies
app.secret_key ='my_ver_secret_key123'
